...
; this time we won't get stream as the return of pairs procedure
; therefor  evaluation of second interleave will cause evaluation of its arguments
; and then the infinite recursion
